...
\begin{figure}[htb]
  \centering
    \includegraphics[width=0.6\textwidth]{calvin-on-writing-a-thesis} % Keine Angabe der Dateiendung nötig, TeX durchsucht den Ordner, in dem dieser Quelltext liegt
